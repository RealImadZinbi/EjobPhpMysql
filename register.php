   ...
   $domaine=mysqli_real_escape_string($db,$_POST['domaine']);
    ...
    if ($password==$password2){
      //create user
       ...
       $sql= "INSERT INTO `users`(username,email,password,phone,domaine) VALUES('$username','$email','$password','$phone','$domaine')";
  ...
  <div class="textbox">
   ...
   <div class="textbox">
    ...
    <div class="textbox">
      ...
      <input type="text" placeholder="Domaine" name="domaine" value="">
