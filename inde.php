...
<html>
    <head>
        <title>Listes de demandes de stage</title>
        <meta charset="utf-8"/>
    ...
    <body>
		...
		<div class="container admin">
            <div class="row">
				...
				<h1><strong>Liste des demandes   </strong><a href="annoncesentre.php" class="btn btn-order"><span class="glyphicon glyphicon-plus"></span> Ajouter une annonce</a></h1>
  ...
  ?>
            ...
            <?php 
                            ...
                            echo '<td width=300>';
                            echo '<a class="btn btn-order" href="view.php?id='.$annonce['id'].'"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>';
