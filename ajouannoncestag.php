<?php
  ...
  if(isset($_POST['depot']))  { //Si bouton deposer annonce est appuyé 
   ...
   $avatar_path = mysqli_real_escape_string($db,$_FILES['avatar']['name']);
       ...
       $sql= "INSERT INTO `deposer`(Nom,Prenom,Ville,Numero,Description,Titre,Email,avatar) VALUES('$nom','$prenom','$ville','$numero','$subject','$Titre','$emailAddress','$avatar_path')"; //Effectuer une requête dans la Base de donnée
      mysqli_query($db,$sql);
...
<div class="container">
  <h1>Déposer votre demande</h1>
      <form class="form" action="ajouannoncestag.php"
